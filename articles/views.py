...
from .form import LoginForm,UserRegistration,ArticleRegistrationForm,ArticleUpdateForm
...
def article_list(request):
    ...
    al=Article.objects.all().order_by('-published')
    paginator=Paginator(al,3)
    ...
    return render(request,'articles.html',{'al':articles,'page':page})
...
#We will update article according to slug
